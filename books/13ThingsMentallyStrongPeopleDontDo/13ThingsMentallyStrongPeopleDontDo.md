...
You have to understand how thoughts behaviors and emotions are intertwined, and use it to develop a 3 pronged approach
Thoughts - id'ing irrational thoughts and replacing them w/ realistic
Behaviors - Be positive despite circumstances
Emotions - Controlling your emotions, not letting them control you

choose behavior based on balanced emotions and rational thinking

Turth about mental strength
* it isn't about acting tough
* doesn't require you to ignore your emotions
* do not have to treat body like a machine
* does mean you have to be completely self reliant
* it is not about positive thinking 
* isn't about chasing happiness
* not a pop psy trend
* isn't synonymous with mental health
...
## Chapter 01: They don't wast time feeling sorry for themselves

we all experience pain/sorrow
But dwelling is self destructive

You are self-pity if yes to the following
* think your problems are worse than others
* if it weren't for bad luck, no luck
* problems add up for you faster than others
* no understands how hard your life is
* more likely to tell what went wrong then what went right
* withdrawn from social and leisure activities to think about problems
* complain about not fair
* struggle to find anything to be grateful for 
* think other people are blessed with easier lives
* world is out to get you

Problems
* waste of time
* leads to more negative
* can become self-fulfilling
* prevent dealing w/ emotions
* cause you to overlook good in life 
* interferes w/ relationships

find thing to make it hard to self-pity
* volunteer
* random act of kindness
* do something active

Replace thoughts
* what is another way I can view the situation
* what advice would I give to another who had problem
